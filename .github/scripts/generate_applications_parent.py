...
def build_parent(output_path, version, bom_version, owner):
	...
	add_text(dependency, 'artifactId', 'applications-bom')
...
if __name__ == '__main__':
	...
	try:
		...
		print(f'Failed to generate applications parent: {exc}', file=sys.stderr)
		raise
